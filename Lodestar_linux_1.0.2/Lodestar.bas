...
dim shared m_fon as Mix_Music ptr
dim shared m_st as Mix_Chunk ptr
dim shared m_st2 as Mix_Chunk ptr
...
PlayMusic(m_fon,"sounds/m_fon.ogg",-1)
SoundLoad(m_st,"sounds/mus.wav")
end if
'*********************
do while quit=0
  cls
...
ReadPlot(level)
if setting_mus=1 then 
    PlayMusic(m_fon,"sounds/m_fon2.ogg",-1)
    SoundLoad(m_st,"sounds/boom.wav")
endif
'*********************
do while quit=0
  cls
...
if setting_mus=1 then
    PlayMusic(m_fon,"sounds/m_fon3.ogg",-1)
    SoundLoad(m_st2,"sounds/mus.wav")
    SoundLoad(m_st,"sounds/boom.wav")
end if
'*********************
do while quit=0
...
DrawGet(0)
if setting_mus=1 then
    PlayMusic(m_fon,"sounds/m_fon4.ogg",-1)
   SoundLoad(m_st2,"sounds/mus.wav")
    SoundLoad(m_st,"sounds/boom.wav")
endif
NewRocket
...
DrawGet(0)
if setting_mus=1 then
    PlayMusic(m_fon,"sounds/m_fon5.ogg",-1)
    SoundLoad(m_st,"sounds/boom.wav")
endif
'*********************
do while quit=0
